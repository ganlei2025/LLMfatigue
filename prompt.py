...
(4) Do NOT add a term unless it is necessary; simpler is better if score is similar.
...
Do NOT add a term unless it is necessary; simpler is better if score is similar.
